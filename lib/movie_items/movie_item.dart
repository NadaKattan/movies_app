...
class MovieItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var height =
        MediaQuery.of(context).size.height; // Correct usage of MediaQuery
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        color: Colors
            .transparent, // The background color can be modified or made transparent
      ),
          ...
          ClipRRect(
            ...
            child: CachedNetworkImage(
              ...
              errorWidget: (context, url, error) =>
                  Center(child: Icon(Icons.error)), // Error widget
            ),
          ),
