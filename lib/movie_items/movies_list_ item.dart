    ...
    return InkWell(
      onTap: () {
        Navigator.of(context)
            .pushNamed(Routes.movieDetails, arguments: "${widget.mov.id}");
      },
      child: Container(
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: widget.mov.posterPath != null
                          ? 'https://image.tmdb.org/t/p/w500${widget.mov.posterPath}'  // Construct full URL for poster
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        widget.mov.voteAverage != null
                            ? widget.mov.voteAverage!.toStringAsFixed(1)  // Format the vote average to one decimal
                            : 'N/A',
                  ...
                  // Movie title
                  Text(
                    widget.mov.title ?? 'No Title',  // Default to 'No Title' if title is null
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        widget.mov.releaseDate ?? 'Unknown',  // Default to 'Unknown' if release date is null
